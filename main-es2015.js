...
let MailPageComponent = class MailPageComponent {
...
MailPageComponent.ctorParameters = () => [
...
let MailtemplateComponent = class MailtemplateComponent {
    constructor(mailService, loginService) {
        this.mailService = mailService;
        this.loginService = loginService;
...
MailtemplateComponent.ctorParameters = () => [
    { type: _mail_service__WEBPACK_IMPORTED_MODULE_2__["MailService"] },
